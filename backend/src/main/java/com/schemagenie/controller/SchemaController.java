...
public class SchemaController {
    ...
    public ResponseEntity<?> generate(@Valid @RequestBody GenerateSchemaRequest request, Authentication authentication) {
        ...
        GeneratedSchema session = schemaService.generate(
                request.getDescription(), request.getDatabaseType(), request.getLanguage(), userId);
    ...
    private Map<String, Object> toResponseBody(GeneratedSchema session) {
        return Map.ofEntries(
                ...
                Map.entry("language", session.getLanguage()),
                ...
                Map.entry("explanation", session.getExplanation() == null ? "" : session.getExplanation()),
